...
public class RtspActivity extends Activity {
    ...
    private void startFly() {
        ...
        keepLeftRightStatus(RtspActivity.this, 110);
        ...
        keepTowardLeftRightStatus(RtspActivity.this, 110);
    }

    private void stopFly() {
        leftRightBar.setProgress(49);
        keepLeftRightStatus(RtspActivity.this, 50);

        forwardBackBar.setProgress(49);
        keepForwardBackStatus(RtspActivity.this, 50);

        throttleBar.setProgress(0);
        keepThrottleStatus(RtspActivity.this, 1);

        towardLeftRightBar.setProgress(49);
